...
`cori.data.pep` provides county-level population estimates from the U.S. Census Bureau's Population Estimates Program (PEP). Data cover 2000–present at annual frequency.
